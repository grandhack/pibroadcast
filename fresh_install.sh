...
rtmp {
	...
	(echo "$piadminpasswd"; echo "$piadminpasswd") | sudo smbpasswd piadmin | tee -a $LOGFILE
	...
	echo "" | tee -a $LOGFILE 
	chown -R $currentuser:$currentuser /boot/pibroadcast-scripts/Dropbox-Uploader/
	echo $USER : $UID | tee -a $LOGFILE
	#sudo -H -u $currentuser /boot/pibroadcast-scripts/Dropbox-Uploader/dropbox_uploader.sh download /Media_Slides/ServerPi/ /home/$currentuser/dropbox_media_slides/ | tee -a $LOGFILE
	/boot/pibroadcast-scripts/Dropbox-Uploader/dropbox_uploader.sh download /Media_Slides/ServerPi/ /home/$currentuser/dropbox_media_slides/ | tee -a $LOGFILE
	...
	echo "#######################################################" | tee -a $LOGFILE
	mv /boot/pibroadcast-scripts/server_menu.sh /home/$currentuser/server_menu.sh
	...
	cp /boot/pibroadcast-scripts/client_services.sh /home/$currentuser/local_sync/scripts/client_services.sh | tee -a $LOGFILE  ## Added as a temp fix ##
	echo | tee -a $LOGFILE
	...
	[ "$(ls -A /home/$currentuser/local_sync/slides/)" ] && echo "/home/$currentuser/local_sync/slides folder Not Empty" || mkdir /home/$currentuser/local_sync/slides/Empty && cp /boot/pibroadcast-scripts/Default_Screen.jpg /home/$currentuser/local_sync/slides/Empty/
	echo | tee -a $LOGFILE
	...
	mv /boot/pibroadcast-scripts/client_menu.sh /home/$currentuser/.bashrc
